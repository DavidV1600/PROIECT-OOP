...
public:
const char* get_Cnp()const{return cnp;}
const char* get_Nume()const{return nume;}
const char* get_Prenume()const{return prenume;} ///Getteri
const int  get_Varsta()const{return varsta;}
const bool get_Sex()const{return sex;}
const int  get_Elo()const{return elo;}
const char* get_Email()const{return email;}
const char* get_NrTelefon()const{return nr_Telefon;}
